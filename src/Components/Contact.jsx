    ...
    <div className='ml-6'>
      ...
      <div className='flex justify-center w-full gap-x-8'>
       <div><h1 className='text-5xl pt-[130px] pr-14 font-[700]'>Get in touch</h1></div>
        <form className='w-[50%]'>          
              <h3 className='pt-3 pb-2 text-lg font-[500]'>Full Name</h3>
              ...
              <h3 className='pt-3 pb-2 text-lg font-[500]'>Email</h3>
              ...
              <h3 className='pt-3 pb-2 text-lg font-[500]'>Message</h3>
              ...
              <button className='py-1 px-3 rounded-full bg-zinc-600 hover:bg-zinc-500 my-3'>Submit</button>
        </form>
      </div>
